...
#    cond=$(cat cond.txt)
 ...
 #  printf "%s\n" "$cond $temp °C | Up: $UP | ↓ $DOWN kB/s ↑ $UPL kB/s | CPU: $CPU% | RAM: $RAM/$TOT | Load: $LOAD | $TEMP0 | $TEMP1 | $TEMP2 | $TEMP3 | $TEMP4 | $DATE"
    ...
    printf "$(0adn) | $(avogadroln) | $(avogadron) | $(jmoln) | $(komodon) | $(libmsymn) | $(molen) | $(notepadqqn) | $(obsd) | $(obsf) | $(obss) | $(openbabeln) | $(openran) | $(openrabn) | $(openracn) | $(openracan) | $(openrad2n) | $(openradn) | $(openragn) | $(openra2n) | $(openramwn) | $(openraspn) | $(openrauran) | $(openrayn) | $(oscn) | $(rofin) | $(spglibn) | $(subln) | $(vimn) | $(vscoden) | $(zshn) | Up: $UP | CPU: $CPU% | RAM: $RAM/$TOT | Load: $LOAD | $DATE"
