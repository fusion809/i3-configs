...
## Requirements
For these configs to work out-of-the-box one needs to have Terminator (for the <kbd>Win</kbd>+<kbd>Enter</kbd> to open a terminal) and Spectacle installed (so that one can take screenshots with <kbd>Win</kbd>+<kbd>F1</kbd>). 
