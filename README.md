# i3-configs
![i3 Arch configs 4.15 commit d883fce](https://fusion809.github.io/images/i3/i3-4.15-archlinux-configs-d883fce-20180920.png)
**Figure 1: [Arch Linux branch](https://github.com/fusion809/i3-configs/tree/archlinux) configs as of 20 September 2018 (commit d883fce), wallpaper is from [openDesktop.org](https://www.opendesktop.org/p/1261940//).** (I choose that branch and not this one as this one is kind of outdated)
