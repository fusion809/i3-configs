...
![The Python configs as of 2 August 2018 on openSUSE Tumbleweed](https://fusion809.github.io/images/i3/i3-4.15-Tumbleweed-20180802.png)
...
Example abbreviated names include:

* OBD means the OBS download files service
...
* Font Awesome icon theme (e.g. the `fonts-font-awesome` package for Debian, best to use the unstable branch), for the sake of getting the workspace icons shown in the above screenshot. The [openSUSE branch](https://github.com/fusion809/i3-configs/tree/opensuse) contains configs that depends less on font awesome as for some reason it does not seem to work on Tumbleweed.
* [common-scripts](https://github.com/fusion809/common-scripts) set up with symlinks in /usr/local/bin. It contains the i3pystatus-notifs.py, which is used for the top bar (containing package notifications) used by these configs.
* [artwork](https://github.com/fusion809/artwork) at $HOME/GitHub/mine/artwork (for wallpaper).
